...
<details>
<summary><b>Q: Sự khác biệt giữa clustered và non-clustered index là gì?</b></summary>
...
<details>
<summary><b>Q: Khi nào bạn dùng composite index?</b></summary>

Khi câu lệnh query thường xuyên lọc dữ liệu (`WHERE`) hoặc sắp xếp dữ liệu (`ORDER BY`) trên nhiều cột cùng một lúc.
</details>

<details>
<summary><b>Q: Index selectivity là gì và tại sao quan trọng?</b></summary>
