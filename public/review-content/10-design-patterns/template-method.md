...
<details>
<summary><b>Q: Sự khác biệt giữa Template Method và Strategy?</b></summary>

Template Method sử dụng Kế thừa (Inheritance): Class cha định nghĩa khung thuật toán cố định và các class con ghi đè các bước cụ thể. Strategy sử dụng Cấu thành (Composition): Class gọi chứa một interface chiến lược và hoán đổi các thuật toán bằng cách nạp các đối tượng chiến lược khác nhau từ ngoài vào.
</details>

<details>
<summary><b>Q: Hook method trong Template Method là gì?</b></summary>

Là phương thức trống hoặc có code mặc định được định nghĩa ở class cha. Các class con có quyền quyết định ghi đè (override) nó hoặc không để can thiệp thêm logic vào khung thuật toán mà không bắt buộc phải viết lại.
</details>

<details>
<summary><b>Q: Khi nào chọn Template Method thay vì Strategy?</b></summary>

Chọn Template Method khi bạn muốn cố định khung sườn thuật toán không cho phép class con thay đổi cấu trúc, chỉ cho phép thay đổi chi tiết các bước con bên trong để tránh trùng lặp code tối đa.
</details>
